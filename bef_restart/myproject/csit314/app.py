...
sys.path.append('C:/projects/myproject')
import config
...
def create_app():
    ...
    from csit314.controller.favourite import (SaveFavouriteController, SellerViewSaveCountController,
                                              ViewSavedFavouriteController)
    ...
    # SellerViewSaveCountController.py
