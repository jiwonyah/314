...
# def viewPropertyListingHistory(agent_id):
#     # 해당 agent_id를 가진 사용자(User) 객체 조회
#     agent = User.query.get(agent_id)
#
#     if not agent:
#         return "Agent not found", 404
#
#     # 해당 agent가 작성한 게시물 목록 조회
#     listings = PropertyListing.query.filter_by(agent_id=agent_id).all()
#
#     return render_template('my_listings.html', agent=agent, listings=listings)
